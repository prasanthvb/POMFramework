#2922 Case Management - Correlation - Base Screen and Actions
@2922
Feature: Case Management - Correlation - Base Screen and Actions
	Testing all the positive and negative Scenarios in ZIF UI Case Management - Correlation - Base Screen and Actions


Background: Launch the Browser with ZIF UI URL for Case Management Correlation Base Screen and Actions
Given Open chrome browser and enter the ZIF UI url for Case Management Correlation Base Screen and Actions
