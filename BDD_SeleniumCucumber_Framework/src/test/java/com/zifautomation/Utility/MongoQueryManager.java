...
public class MongoQueryManager {
    ...
    public FindIterable<Document> getAllDocuments(MongoDatabase database,String collectionName){
    ...
    public FindIterable<Document> getDocumentsWithFields(MongoDatabase database, String collectionName, Map<String,String> fields){
        setCollection(database,collectionName);
