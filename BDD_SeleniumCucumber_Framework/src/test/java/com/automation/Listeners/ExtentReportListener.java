...
public class ExtentReportListener {
	 ...
	 * switch (teststatus) { case "FAIL":
	 * test.fail(MarkupHelper.createLabel("Test Case is Failed : ",
	 * ExtentColor.RED)); //test.error(throwable.fillInStackTrace());
	 * 
	 * try { test.addScreenCaptureFromPath(captureScreenShot(driver)); } catch
	 ...
	 * case "PASS":
	 * 
	 * test.pass(MarkupHelper.createLabel("Test Case is Passed : ",
	 * ExtentColor.GREEN));
	 * 
	 * break;
	 * 
