...
public class Testcases001 extends Base {
...
//		}  
	...
	public void CMPInvalidLoginTest() throws IOException, InterruptedException {
		...
		try {
			...
			new Loginfunction(driver).Enterthecredentials(UserName2, Password2);
		...
		try {
			...
			new Loginfunction(driver).Enterthecredentials(UserName3, Password3);
			new Loginfunction(driver).getTextOfInvalidUsernameOrpassword();
		...
		try {
			...
			new Loginfunction(driver).Enterthecredentials(UserName4, Password4);
			new Loginfunction(driver).getTextOfInvalidUsernameOrpassword();
