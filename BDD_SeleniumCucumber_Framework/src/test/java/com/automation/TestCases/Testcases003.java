...
public class Testcases003 extends Base {
	...
	public void cmpLogoutTest() throws IOException, InterruptedException {
		...
		try {
			...
			test.log(Status.PASS,
					"Verified the user is in Login Page after Logout of Application and click on Backward");
	...
	public void openNewTabTest() throws IOException, InterruptedException {
		...
		try {
			...
			test.log(Status.PASS,
					"Verified the User is active on the other session of the tab of the same browser with same URL ");
