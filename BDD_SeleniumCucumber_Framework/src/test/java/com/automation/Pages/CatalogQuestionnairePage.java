...
import static com.automation.Listeners.ExtentReportListener.captureScreenShot;
import static org.testng.Assert.assertTrue;

public class CatalogQuestionnairePage {
	WebDriver driver;

	public CatalogQuestionnairePage(WebDriver driver) {
		this.driver = driver;
