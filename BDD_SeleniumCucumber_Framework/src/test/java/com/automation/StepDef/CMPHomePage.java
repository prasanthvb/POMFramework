...
import com.automation.Pages.CMPLandingpage;
...
public class CMPHomePage extends ExtentReportListener {
	...
	public void Click_on_pagination_and_verify_the_user_traverse_to_next_page() throws Throwable {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("And"),
					"Click_on_pagination_and_verify_the_user_traverse_to_next_page");
	...
	public void Verify_all_the_fields_in_Add_a_New_Customer_side_panel() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("Then"),
					"Verify_all_the_fields_in_Add_a_New_Customer_side_panel");
	...
	public void verify_that_the_Create_Customer_button_is_disabled() {
		...
		try {
			...
			// driver.findElement(By.xpath("//span[text()='Create Customer']"));
			// JavascriptExecutor js = (JavascriptExecutor) driver;
			// Boolean disabled = (Boolean) js.executeScript("return
			// arguments[0].hasAttribute(\"disabled\");", CreateCustomerbtn);
	...
	public void user_enters_all_the_data() {
		...
		try {
			...
			new CMPLandingpage(driver).EnteralldetailsinAddCustomer(CustomerName, CustomerLocation, AccountManager,
					AMEmail, Implementation, ZIFcatalogueEmailID, ZIFAdminEmailID);
	...
	public void Customer_has_been_created_successfully() {
		...
		try {
			...
			WebElement customercreatedsuccess = driver
					.findElement(By.xpath("//span[contains(text(),'Customer has been created successfully')]"));
	...
	public void Customer_record_already_exists() {
		...
		try {
			...
			WebElement customercreatedsuccess = driver
					.findElement(By.xpath("//span[contains(text(),'Customer record already exists')]"));
	...
	public void verify_that_the_Customer_is_displayed_in_the_List_of_Customers() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("Then"),
					"verify_that_the_Customer_is_displayed_in_the_List_of_Customers");
