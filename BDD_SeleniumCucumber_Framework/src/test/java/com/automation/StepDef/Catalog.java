...
public class Catalog extends ExtentReportListener {
	...
	public void open_chrome_browser_and_enter_the_url() {
		try {
			...
			Map<String, String> TestDataInMap = ExcelHandler
					.getTestDataInMap(properties.getProperty("testdatafilepath"), sheet1, TestCaseId1);
	...
	public void user_selects_CAPEX_Optimization_in_business_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("When"),
					"user_selects_CAPEX_Optimization_in_business_outcomes");
			driver.navigate().refresh();
			new CatalogHomePage(driver).UnselectAllBusinessoutcomes();

			WebElement CBX = driver.findElement(By.xpath(
					"//h5[text()='CAPEX Optimization']//parent::div//preceding-sibling::div//p-checkbox//div//div[2]"));
	...
	public void verify_Correlation_Root_Cause_Identification_are_selected_in_technical_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("Then"),
					"user_selects_CAPEX_Optimization_or_Business_Service_Assurance_in_business_outcomes");
			new CatalogHomePage(driver).CAPEX_Optimizationtechnicaloutcomes();
			logInfo.pass(
					"Successfully verified CAPEX Optimization or Business Service Assurance technical outcomes in ZIF catalog HomePage");
			logInfo.addScreenCaptureFromPath(captureScreenShot(driver));
	...
	public void user_unselects_CAPEX_Optimization_in_business_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("When"),
					"user_unselects_CAPEX_Optimization_in_business_outcomes");
	...
	public void verify_Correlation_Root_Cause_Identification_are_unselected_in_technical_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("When"),
					"verify_Correlation_Root_Cause_Identification_are_unselected_in_technical_outcomes");
			new CatalogHomePage(driver).CAPEX_OptimizationtechnicaloutcomesUnselect();
			logInfo.pass(
					"Successfully unselected and verified CAPEX Optimization or Business Service Assurance technical outcomes in ZIF catalog HomePage");
			logInfo.addScreenCaptureFromPath(captureScreenShot(driver));
	...
	public void user_selects_OPEX_Optimization_in_business_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("When"),
					"user_selects_OPEX_Optimization_in_business_outcomes");

			WebElement CBX = driver.findElement(By.xpath(
					"//h5[text()='OPEX Optimization']//parent::div//preceding-sibling::div//p-checkbox//div//div[2]"));
			CBX.click();
	...
	public void verify_all_the_fields_are_displayed_in_the_Home_Page() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("Then"),
					"verify_all_the_fields_are_displayed_in_the_Home_Page");
	...
	public void verify_Correlation_Root_Cause_Identification_Prediction_Intelligent_Automation_are_selected_in_techical_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("Then"),
					"verify_Correlation_Root_Cause_Identification_Prediction_Intelligent_Automation_are_selected_in_techical_outcomes");
	...
	public void user_will_get_the_invalid_username_or_password_error_message() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("Then"),
					"user_will_get_the_invalid_username_or_password_error_message");
	...
	public void user_unselects_OPEX_Optimization_in_business_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("When"),
					"user_unselects_OPEX_Optimization_in_business_outcomes");
	...
	public void verify_Correlation_Root_Cause_Identification_Prediction_Intelligent_Automation_are_unselected_in_techical_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("Then"),
					"verify_Correlation_Root_Cause_Identification_Prediction_Intelligent_Automation_are_unselected_in_techical_outcomes");
			new CatalogHomePage(driver).OPEX_OptimizationtechnicaloutcomesUnselect();
			logInfo.pass(
					"Successfully unselected and verified Opex Optimization technical outcomes in ZIF catalog HomePage");
			logInfo.addScreenCaptureFromPath(captureScreenShot(driver));
	...
	public void user_selects_Blueprinting_Enterprise_in_business_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("When"),
					"user_selects_Blueprinting_Enterprise_in_business_outcomes");

			WebElement CBX = driver.findElement(By.xpath(
					"//h5[text()='Blueprinting Enterprise']//parent::div//preceding-sibling::div//p-checkbox//div//div[2]"));
			CBX.click();
	...
	public void verify_Auto_Discovery_is_selected_in_technical_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("Then"),
					"verify_Auto_Discovery_is_selected_in_technical_outcomes");
	...
	public void user_unselects_Blueprinting_Enterprise_in_business_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("When"),
					"user_unselects_Blueprinting_Enterprise_in_business_outcomes");
	...
	public void verify_Auto_Discovery_is_unselected_in_technical_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("When"),
					"verify_Auto_Discovery_is_unselected_in_technical_outcomes");
			new CatalogHomePage(driver).Blueprinting_EnterprisetechnicaloutcomesUnselect();
			logInfo.pass(
					"Successfully unselected and verified Blueprinting Enterprise technical outcomes in ZIF catalog HomePage");
			logInfo.addScreenCaptureFromPath(captureScreenShot(driver));
	...
	public void user_selects_Optimization_of_Compute_in_business_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("When"),
					"user_selects_Optimization_of_Compute_in_business_outcomes");

			WebElement CBX = driver.findElement(By.xpath(
					"//h5[text()='Compute Utilization & Optimization']//parent::div//preceding-sibling::div//p-checkbox//div//div[2]"));
			CBX.click();
	...
	public void verify_Prediction_is_selected_in_technical_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("Then"),
					"verify_Prediction_is_selected_in_technical_outcomes");
	...
	public void user_unselects_Optimization_of_Compute_in_business_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("When"),
					"user_unselects_Optimization_of_Compute_in_business_outcomes");
	...
	public void verify_Prediction_is_unselected_in_technical_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("When"),
					"verify_Prediction_is_unselected_in_technical_outcomes");
			new CatalogHomePage(driver).Optimization_of_ComputetechnicaloutcomesUnselect();
	...
	public void user_selects_Improvement_in_User_Experience_in_business_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("When"),
					"user_selects_Improvement_in_User_Experience_in_business_outcomes");

			WebElement CBX = driver.findElement(By.xpath(
					"//h5[text()='Improvement in User Experience']//parent::div//preceding-sibling::div//p-checkbox//div//div[2]"));
			CBX.click();
	...
	public void verify_Correlation_Root_Cause_Identification_Prediction_are_selected_in_technical_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("Then"),
					"verify_Correlation_Root_Cause_Identification_Prediction_are_selected_in_technical_outcomes");
			new CatalogHomePage(driver).Improvement_in_User_Experiencetechnicaloutcomes();
			logInfo.pass(
					"Successfully verified Improvement in User Experience or Improvement in Application Availability technical outcomes in ZIF catalog HomePage");
			logInfo.addScreenCaptureFromPath(captureScreenShot(driver));
	...
	public void user_unselects_Improvement_in_User_Experience_in_business_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("When"),
					"user_unselects_Improvement_in_User_Experience_in_business_outcomes");
	...
	public void verify_Correlation_Root_Cause_Identification_Prediction_are_unselected_in_technical_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("When"),
					"verify_Correlation_Root_Cause_Identification_Prediction_are_unselected_in_technical_outcomes");
			new CatalogHomePage(driver).Improvement_in_User_ExperiencetechnicaloutcomesUnselect();
			logInfo.pass(
					"Successfully unselected and verified Improvement in User Experience or Improvement in Application Availability technical outcomes in ZIF catalog HomePage");
			logInfo.addScreenCaptureFromPath(captureScreenShot(driver));
	...
	public void user_selects_Improvement_in_Business_Service_Assurance_in_business_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("When"),
					"user_selects_Improvement_in_Business_Service_Assurance_in_business_outcomes");

			WebElement CBX = driver.findElement(By.xpath(
					"//h5[text()='Improvement in Business Service Assurance']//parent::div//preceding-sibling::div//p-checkbox//div//div[2]"));
			CBX.click();
	...
	public void user_unselects_Improvement_in_Business_Service_Assurance_in_business_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("When"),
					"user_unselects_Improvement_in_Business_Service_Assurance_in_business_outcomes");
	...
	public void user_selects_Shift_Left_in_business_outcomes() {
		...
		try {
			...
			WebElement CBX = driver.findElement(By
					.xpath("//h5[text()='Shift Left']//parent::div//preceding-sibling::div//p-checkbox//div//div[2]"));
			CBX.click();
	...
	public void verify_Intelligent_Automation_Intelligent_Triaging_are_selected_in_technical_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("Then"),
					"verify_Intelligent_Automation_Intelligent_Triaging_are_selected_in_technical_outcomes");
			new CatalogHomePage(driver).Shift_Lefttechnicaloutcomes();
	...
	public void verify_Intelligent_Automation_Intelligent_Triaging_are_unselected_in_technical_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("When"),
					"verify_Intelligent_Automation_Intelligent_Triaging_are_unselected_in_technical_outcomes");
			new CatalogHomePage(driver).Shift_LefttechnicaloutcomesUnselect();
	...
	public void user_selects_Eliminating_Digital_Dirt_in_business_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("When"),
					"user_selects_Eliminating_Digital_Dirt_in_business_outcomes");

			WebElement CBX = driver.findElement(By.xpath(
					"//h5[text()='Eliminating Digital Dirt']//parent::div//preceding-sibling::div//p-checkbox//div//div[2]"));
			CBX.click();
	...
	public void verify_Dependency_Mapping_is_selected_in_technical_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("Then"),
					"verify_Dependency_Mapping_is_selected_in_technical_outcomes");
	...
	public void user_unselects_Eliminating_Digital_Dirt_in_business_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("When"),
					"user_unselects_Eliminating_Digital_Dirt_in_business_outcomes");
	...
	public void verify_Dependency_Mapping_is_unselected_in_technical_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("When"),
					"verify_Dependency_Mapping_is_unselected_in_technical_outcomes");
			new CatalogHomePage(driver).Eliminating_Digital_DirttechnicaloutcomesUnselect();
			logInfo.pass(
					"Successfully unselected and verified Eliminating Digital Dirt technical outcomes in ZIF catalog HomePage");
			logInfo.addScreenCaptureFromPath(captureScreenShot(driver));
	...
	public void user_selects_Improvement_in_Application_Availability_in_business_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("When"),
					"user_selects_Improvement_in_Application_Availability_in_business_outcomes");

			WebElement CBX = driver.findElement(By.xpath(
					"//h5[text()='Improvement in Application Availability']//parent::div//preceding-sibling::div//p-checkbox//div//div[2]"));
			CBX.click();
	...
	public void user_unselects_Improvement_in_Application_Availability_in_business_outcomes() {
		...
		try {
			logInfo = test.createNode(new GherkinKeyword("When"),
					"user_unselects_Improvement_in_Application_Availability_in_business_outcomes");
